...
![](./neural-network-2-1.png)                                                               **A Simple Neural Network with 1 hidden layer**
...
![Artificial Neural Networks](./multilayer-nn-1.png)Neural Network with 2 Hidden Layers between the input and the output
...
![Artificial Neural Networks - Black Box Concept - Computed Units](./nn-blackbox-1-1.png)Artificial Neural Networks – Black Box Concept – Computed Units
...
![Artificial Neural Networks](./nn-working-2-1.png)Artificial neural network showing weights, bias and activation function
