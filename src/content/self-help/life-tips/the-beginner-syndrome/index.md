...
An impostor hides behind a mask, and relies on deceit and dishonesty. A beginner shares the dilemma and struggles of getting things right. It is an uncomfortable feeling.
...
I will be going through the syndrome yet again though. I am starting my [YouTube](https://www.youtube.com/channel/UClW56GhpAKrRu-ZSqAoPjHg?sub_confirmation=1) channel and a [Discord Server](https://discord.gg/CVcKf3kt) for [Wisdom Geek](https://www.wisdomgeek.com). But this time, I am better equipped to handle the challenge and I also have a little bit of an audience. It would be great if you could show some support by subscribing the channel and joining the server too!
